...
\begin{enumerate}
    ...
    \item \textbf{Stop cost:} $1$ for each \emph{distinct} destination floor among the groups in
    the trip (door open/close penalty). For example, a trip carrying 3 groups bound for floors
    $\{2, 5, 5\}$ has a stop cost of $2$, since there are two distinct destination floors.
